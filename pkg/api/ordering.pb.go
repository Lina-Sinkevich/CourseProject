...
type OrderInfo struct {
	...
	GameName int32 `protobuf:"varint,1,opt,name=gameName,proto3" json:"gameName,omitempty"` //название игры, которую хочет заказчик.
	Fio      int32 `protobuf:"varint,2,opt,name=fio,proto3" json:"fio,omitempty"`           //ФИО заказчика
}
...
func (x *OrderInfo) GetGameName() int32 {
	if x != nil {
		return x.GameName
	}
	return 0
...
var file_ordering_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x67, 0x61, 0x6d, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x10,
	0x0a, 0x03, 0x66, 0x69, 0x6f, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x66, 0x69, 0x6f,
